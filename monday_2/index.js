...
// alert("hrghiuehlsvureakgvufjvherusfhlreugluiv")

let temp = "";
for (let i = 0; i < products_data.length; i++) {
    temp += `<div class="box">
    
            <h2 class="title">${products_data[i].title}</h2>
            <h3 class="category">${products_data[i].category}</h3>
        <img src="${products_data[i].images}" alt="" class="img">
            
            
            <h3 class="rating ${products_data[i].rating > 3 ? "green" : "red"}">${products_data[i].rating}</h3>
            <h2 class="price">$ ${products_data[i].price}</h2>
            <button onclick=on() class="add-to-cart">Add to Cart</button>
        </div>`
}
